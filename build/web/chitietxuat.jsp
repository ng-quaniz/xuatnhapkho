              ...
              <div class="accordion-item" >
                ...
                <div class="readMoreForm">
                  <form  class="row g-6" id="myForm">
                      <div class="c"> <p class="title_formAccor">Mã: <span class="d" id="name">${px.id}-${id}</span></p><p class="title_formAccor">Ngày nhập: <span class="d">${px.ngaytao}</span></p></div>
                        <div class="c"> <p class="title_formAccor">Hình thức <span class="d" id="name">${px.loai}</span></p></div>
